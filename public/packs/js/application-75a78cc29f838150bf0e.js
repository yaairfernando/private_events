...
__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module 'bootstrap/dist/js/bootstrap'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())); // Uncomment to copy all static images under ../images to the output folder and reference
...
function deleteErrors() {
  ...
  if (btnClose) {
    btnClose.addEventListener('click', function () {
      btnClose.parentElement.styles.display = 'none';
    });
  }
...
/******/ });
//# sourceMappingURL=application-75a78cc29f838150bf0e.js.map