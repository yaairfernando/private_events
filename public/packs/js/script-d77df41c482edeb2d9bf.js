...
/***/ "./app/javascript/packs/animatescroll.js":
/*!***********************************************!*\
  !*** ./app/javascript/packs/animatescroll.js ***!
  \***********************************************/
...
/* harmony import */ var _animatescroll__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./animatescroll */ "./app/javascript/packs/animatescroll.js");
/* harmony import */ var _animatescroll__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_animatescroll__WEBPACK_IMPORTED_MODULE_1__);
...
//   upcoming.addEventListener('click', $('#upcoming').animatescroll({scrollSpeed:2000,easing:'swing'}) )
//   // $('a#upcoming').on('click',$('#upcoming').animatescroll({scrollSpeed:2000,easing:'swing'}))
// );
...
function upcoming() {
  ...
  if (upcoming) {
    ...
    animated_scroll_to__WEBPACK_IMPORTED_MODULE_2___default()(upcoming);
  }
}

function passed() {
  var passed = document.getElementById("passedEvents");

  if (passed) {
    console.log("passed");
    animated_scroll_to__WEBPACK_IMPORTED_MODULE_2___default()(passed);
  }
}

jquery__WEBPACK_IMPORTED_MODULE_0___default()(function () {
  return jquery__WEBPACK_IMPORTED_MODULE_0___default()("#up_coming").on("click", function () {
    return upcoming();
  });
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()(function () {
  return jquery__WEBPACK_IMPORTED_MODULE_0___default()("#passed").on("click", function () {
    return passed();
  });
}); // $(() =>
//   $('#passed').on('click', $('#passed').animatescroll({scrollSpeed:2000,easing:'swing'}))
// );
// $(() =>
//   $('#upcoming').on('click', $('#upcoming').animatescroll({scrollSpeed:2000,easing:'swing'}))
// );
// $(() =>
//   $('a#passed').on('click', passedEvent())
// );
// function passedEvent() {
//   console.log("passed")
//   $('#passed').animatescroll({scrollSpeed:2000,easing:'swing'})
// }
// function upcomingEvent() {
//   console.log("upcoming")
//   $('#upcoming').animatescroll({scrollSpeed:2000,easing:'swing'})
// }
...
/******/ });
//# sourceMappingURL=script-d77df41c482edeb2d9bf.js.map